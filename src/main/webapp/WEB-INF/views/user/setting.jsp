...
<div class="container">
    <div class="box">
        ...
        <form action="" class="form-horizontal" id="basicForm">
            ...
            <div class="form-actions">
                <button id="basicBtn" type="button" class="btn btn-primary">保存</button>
            </div>
    ...
    <div class="box">
        ...
        <form action="" class="form-horizontal" id="passwordForm">
            ...
            <div class="form-actions">
                <button id="passwordBtn" type="button" class="btn btn-primary">保存</button>
            </div>
    ...
    <div class="box">
        ...
        <form action="" class="form-horizontal">
            <div class="control-group">
                ...
                <div class="controls">
                    <img id="avatar" src="http://oi3rlw2s2.bkt.clouddn.com/${sessionScope.curr_user.avatar}?imageView2/1/w/40/h/40" class="img-circle" alt="">
                </div>
            </div>
            <hr>
